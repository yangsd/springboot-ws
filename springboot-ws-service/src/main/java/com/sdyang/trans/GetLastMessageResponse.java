...
@XmlRootElement(name = "GetLastMessageResponse", namespace = "http://webservice.tfc.tmri.com")
public class GetLastMessageResponse {

    @XmlElement(name = "GetLastMessageReturn", namespace = "http://webservice.tfc.tmri.com", required = true)
