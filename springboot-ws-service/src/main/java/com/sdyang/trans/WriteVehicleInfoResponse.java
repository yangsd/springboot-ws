...
@XmlRootElement(name = "WriteVehicleInfoResponse", namespace = "http://webservice.tfc.tmri.com")
public class WriteVehicleInfoResponse {

    @XmlElement(name = "WriteVehicleInfoReturn", namespace = "http://webservice.tfc.tmri.com")
