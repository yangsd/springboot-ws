...
@XmlRootElement(name = "QuerySyncTimeResponse", namespace = "http://webservice.tfc.tmri.com")
public class QuerySyncTimeResponse {

    @XmlElement(name = "QuerySyncTimeReturn", namespace = "http://webservice.tfc.tmri.com", required = true)
