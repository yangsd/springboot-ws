 ...
 *         &lt;element name="cdh" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "WriteVehicleInfoRequest", namespace = "http://webservice.tfc.tmri.com")
public class WriteVehicleInfoRequest {
     ...
     *     
     */
    public void setCdh(String value) {
        this.cdh = value;
    }
